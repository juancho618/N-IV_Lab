...
Xtest =  reduce(lambda c, x: c + [c[-1] + 10], range(100),[0])[1:]
...
pylab.figure()
pylab.plot(Xtest,list(map(lambda x: 10, range(100))),label='true measurements', color='r')
pylab.plot(dist,'b-',label='Velocity estimate')
